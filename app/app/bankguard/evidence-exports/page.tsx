...
export default function BankGuardEvidenceExportsPage() {
  const { isAuthenticated } = useAuth()
  const { data, error, isLoading } = useSWR(isAuthenticated ? "bankguard-evidence" : null, fetchTimeline, { revalidateOnFocus: false })
  const events = data ?? []

  return (
    <PageLayout role="bankguard" title="Evidence Exports" subtitle="Hash-chained evidence trail for your institution">
